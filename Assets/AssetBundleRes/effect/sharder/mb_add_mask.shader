...
////// Emissive:
                ...
                fixed3 emissive = (((_Amitex_var.rgb*_Mask_var.r)*_TintColor.rgb*i.vertexColor.rgb)*(_Amitex_var.a*_TintColor.a*i.vertexColor.a)*_AmitIntensity);
